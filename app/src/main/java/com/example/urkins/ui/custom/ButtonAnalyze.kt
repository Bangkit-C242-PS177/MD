...
class ButtonAnalyze : AppCompatButton {
    ...
    init {
        ...
        enabledBackground =
            ContextCompat.getDrawable(context, R.drawable.bg_btn_analyze) as Drawable
        disableBackground = ContextCompat.getDrawable(
            context,
            R.drawable.bg_btn_analyze_disable
        ) as Drawable
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        gravity = CENTER
        text =
            if (isEnabled) context.getString(R.string.enabled_btn_analyze_text) else context.getString(
                R.string.disable_btn_analyze_text
            )
    }
}